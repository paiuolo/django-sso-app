...
from ...tests.factories import UserTestCase
...
class TestLogin(UserTestCase):
    ...
    def test_can_login_with_username(self):
        ...
        response = client.post(
            reverse('rest_login'),
            data=json.dumps(self._get_login_object(new_user.username, new_pass)),
            content_type='application/json'
        )
    ...
    def test_django_superuser_can_not_login_from_api_views(self):
        ...
        response = client.post(
            reverse('rest_login'),
            data=json.dumps(self._get_login_object(new_admin_user.username, new_admin_pass)),
            content_type='application/json'
        )
    ...
    def test_django_staff_user_can_not_login_from_api_views(self):
        ...
        response = client.post(
            reverse('rest_login'),
            data=json.dumps(self._get_login_object(new_staff_user.username, new_staff_pass)),
            content_type='application/json'
        )
